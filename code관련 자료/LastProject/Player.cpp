...
CTerrainPlayer::CTerrainPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext)
{
	...
	m_pSkinnedAnimationController->SetTrackStartEndTime(1, 2.5f, 3.0f); //전진
	//m_pSkinnedAnimationController->SetTrackStartEndTime(1, 3.0f, 3.8f); //후진
	//m_pSkinnedAnimationController->SetTrackStartEndTime(1, 3.8f, 4.5f); //오른쪽
	//m_pSkinnedAnimationController->SetTrackStartEndTime(1, 4.5f, 5.2f); //왼쪽
